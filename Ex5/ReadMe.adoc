:Project: Inserção de figura no relógio digital
...
1. Abra o arquivo Ex5.ino na Arduino IDE
...
2. Faça a montagem do OLED conforme o diagrama:
...
....
 Ex5                    => Pasta do sketch Arduino
  ├── Ex5.ino           => Arquivo principal do sketch
